...
pub const LOGBLOCKS:    usize = MAXOPBLOCKS * 3;   // max data blocks in on-disk log
...
pub const USERSTACK:    u64   = 4;                 // user stack pages
pub const KSTACKPAGES:  u64   = 4;                 // kernel stack pages per process
